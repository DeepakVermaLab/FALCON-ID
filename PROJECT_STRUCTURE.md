...
FALCON-ID is organized as a notebook-first research repository.

- `EDA/`: exploratory analysis notebooks and downloaded EDA reports.
- `PREPROCESSING/`: dataset preprocessing and combined dataset builder notebooks.
- `CLIENT_DATASET_BUILDER/`: non-IID client dataset construction notebooks.
